...
(function(root, factory) {  // eslint-disable-line
    ...
    function distance(a, b) {
      if (a.length !== 3 || b.length !== 3) {
        throw new Error("Os arrays devem ter tamanho 3");
      }
    ...
    function roundVector(decimals, v){
      let x = Math.round( v[0] * decimals ) / decimals;
      let y = Math.round( v[1] * decimals ) / decimals;
      let z = Math.round( v[2] * decimals ) / decimals;
      return [x,y,z]
    }
    ...
    function generateRandomPoint(center, radius) {
      ...
      // Calculate Cartesian coordinates relative to the center point
     ...
     * direction, transforms that direction by the matrix, and returns the result;transformPoint
